...
export default function Payroll() {
  ...
  return (
    <div>
      <PageHead
        title="Payroll & PAYE"
        sub={<>PAYE is computed on the <b>new NTA 2025 bands</b> (first ₦800,000 at 0%), after the statutory 8% pension relief and <b>rent relief</b> (lower of 20% of rent or ₦500k, applied when an employee's rent is declared). Remit to {state.profile.state} IRS by the <b>10th</b> of the following month; employer annual return due <b>31 January</b>.</>}
        right={
          ...
          <div className="card card-pad mb16">
            ...
            <div style={{ overflowX: 'auto' }}>
              <table className="tbl">
                ...
                <tfoot>
                  <tr className="strong"><td colSpan={6}>Totals</td><td className="num">{naira(annualPAYE)}</td><td className="num">{naira(monthlyRemit)}</td><td colSpan={3} /></tr>
                </tfoot>
              </table>
            </div>
          </div>
